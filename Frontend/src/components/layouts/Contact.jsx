  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
        {/* Contact Information */}
        <Motion.div
          className="space-y-8 rounded-md p-6 md:p-8 shadow-sm border border-gray-100"
        ...
        {/* Contact Form */}
        <Motion.div
          className="lg:col-span-2 rounded-md bg-white px-3 py-6 md:p-8 shadow-sm border border-gray-100"
          initial={{ opacity: 0, x: 40 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
